    ...
    window.ClientSideValidations.validators = {
      ...
      local: {
        ...
        format: function(element, options) {
          ...
          match = new RegExp(options["with"].source);
          if (message) {
          ...
          if (options["with"] && !match.test(element.val())) {
            return options.message;
          }
      ...
      'ActionView::Helpers::FormBuilder': {
        add: function(element, settings, message) {
          ...
          if (element.data('valid') !== false && (form.find("label.message[for='" + (element.attr('id')) + "']")[0] == null)) {
            ...
            var errorLabel = inputErrorField.find('label.message').attr('for', element.attr('id'));
            labelErrorField.find('label.message').attr('for', element.attr('id'));
            labelErrorField.insertAfter(label);
            labelErrorField.find('label#label_tag').replaceWith(label);
            labelErrorField.append(errorLabel);
          }
