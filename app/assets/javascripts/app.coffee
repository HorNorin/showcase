...
.factory "Session", ($rootScope, Auth, $location) ->
  service =
    login: (user) ->
      config =
      headers:
...
.controller "HomeController", ($scope, Show, Session) ->
...
.controller "SessionsController", ($scope, Auth, $location, Session) ->
